define(function () {
    ...
    __zovyeApi.default = function(op, params, cb) {
        if (__zovyeApi.resultFN[op]) {
            ...
            __zovyeApi.showResult(Object.assign({ op }, params), __zovyeApi.url, false, cb);
        }   
    }
    ...
    __zovyeApi.enableOp = function(selector = 'body', opName = 'op') {
        $(selector).on('click', '[data-' + opName + ']', function (e) {
            ...
            if (op) {
                if (__zovyeApi[op]) {
                    __zovyeApi[op]($(this), function(params, cb) {
                        __zovyeApi.default(op, params, cb);
                    });
                } else {
