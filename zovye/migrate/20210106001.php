...
if (!We7::pdo_field_exists($tb_name.'_user', 'superior_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_account', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_advertising', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_advs_stats', 'advs_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_agent_msg', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_commission_balance', 'x_val')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_device_feedback', 'user_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_device_groups', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_device', 'group_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_goods_voucher_logs', 'owner_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_goods_voucher', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_goods', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_keepers', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_login_data', 'user_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_table_exists($tb_name.'_maintenance')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_maintenance', 'device_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_order', 'order_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_order', 'result_code')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_replenish', 'device_uid')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_settings_user', 'locked_uid')) {
    $sql = <<<SQL
