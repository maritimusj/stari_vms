...
if (We7::pdo_field_exists($tb_name.'_user', 'passport')) {
    $sql = <<<SQL
...
if (We7::pdo_field_exists($tb_name.'_principal', 'enable')) {
    $sql = <<<SQL
...
if (We7::pdo_field_exists($tb_name.'_referral', 'agent_id')) {
    $sql = <<<SQL
...
if (!We7::pdo_field_exists($tb_name.'_keeper_devices', 'f20230419')) {
    $sql = <<<SQL
